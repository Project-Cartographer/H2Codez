...
static bool TAG_ADD_IMPORT_INFO_BLOCK(tag_block_ref *import_info)
{
...
static bool TAG_ADD_IMPORT_INFO_ADD_DATA_(tag_block_ref *IMPORT_INFO_OFFSET, file_reference *FILE_REF)
{
...
static bool TAG_FILE_CHECK_IS_WRITEABLE(datum TAG, bool suppress_error = false)
{
